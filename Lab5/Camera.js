...
Camera.prototype.tumble = function (rx, ry) {
    ...
    var pPrime = mult(view, tumblePoint); //pPrime matrix
        ...
        //first calculate matrix A, which represents the rotation about the ry line 
...
Camera.prototype.keyAction = function (key) {
    var alpha = 3.0;  // used to control the amount of a turn during the flythrough
